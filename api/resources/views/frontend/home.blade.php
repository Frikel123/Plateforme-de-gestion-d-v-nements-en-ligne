            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li><a href="{{route('user.seConnecter')}}">Login</a></li>
                        <li><a href="{{route('user.inscrire')}}">Register</a></li>
                    </ul>
                </nav>
                <a href="{{route('dashboard')}}" class="primary-btn top-btn"><i class="fa fa-ticket"></i> Ticket</a>
            </div>
    ...
    <section class="newslatter-section">
        <form action="{{ route('contact.store') }}" method="POST" id="contact-form" role="form">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <textarea class="form-control" rows="6" placeholder="Tell us about your message" name="messages" required=""></textarea>
            </div>
